...
curl -v  --location --request DELETE  'http://localhost:'$PORT'/admin/realms/verifiable-credentials' -H "Authorization: Bearer "$MASTER_TOKEN -H "Content-Type: application/json" 
