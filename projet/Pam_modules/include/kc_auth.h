 ...
 * @param[in] user le nom de l'utilisateur
 * @param[in] pass le mot de passe de l'utilisateur
 * @param[out] access_token pointeur sur char * : le jeton d'accès
 ...
 * @param[out] p_public_key pointer on char * : pubkey variable
